  ...
  return (
    <div className="py-16 px-4">
      <div className="container mx-auto max-w-4xl">
        <h1 className="text-4xl font-bold text-center mb-12 text-gray-900">Algemene Voorwaarden</h1>
        ...
        <Card className="border-ffect-light/20">
          <CardContent className="p-8 prose prose-lg max-w-none">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">3. Aanbiedingen en offertes</h2>
            <p className="text-gray-700 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">5. Uitvoering diensten</h2>
            <p className="text-gray-700 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">6. Annulering</h2>
            <p className="text-gray-700 mb-4">Annuleringen zijn mogelijk onder de volgende voorwaarden:</p>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">7. Betaling</h2>
            <p className="text-gray-700 mb-6">
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">9. Intellectueel eigendom</h2>
            <p className="text-gray-700 mb-6">
            ...
            <p className="text-sm text-gray-600">Laatst bijgewerkt: {new Date().toLocaleDateString("nl-BE")}</p>
          </CardContent>
        </Card>
      </div>
    </div>
