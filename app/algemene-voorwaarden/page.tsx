  ...
  return (
    <div className="py-16 px-4">
      <div className="container mx-auto max-w-4xl">
        <h1 className="text-4xl font-rawest font-bold text-center mb-12 text-foreground">Algemene Voorwaarden</h1>
        ...
        <Card className="border-ffect-light/20 bg-card text-card-foreground">
          <CardContent className="p-8 prose prose-lg max-w-none">
            <h2 className="text-2xl font-rawest font-bold text-foreground mb-4">1. Definities</h2>
            ...
            <h2 className="text-2xl font-rawest font-bold text-foreground mb-4">2. Toepasselijkheid</h2>
            <p className="text-foreground mb-6">
            ...
            <h2 className="text-2xl font-rawest font-bold text-foreground mb-4">3. Aanbiedingen en offertes</h2>
            <p className="text-foreground mb-6">
            ...
            <h2 className="text-2xl font-rawest font-bold text-foreground mb-4">4. Totstandkoming overeenkomst</h2>
            <p className="text-foreground mb-6">
            ...
            <h2 className="text-2xl font-rawest font-bold text-foreground mb-4">5. Uitvoering diensten</h2>
            <p className="text-foreground mb-6">
            ...
            <h2 className="text-2xl font-rawest font-bold text-foreground mb-4">6. Annulering</h2>
            ...
            <h2 className="text-2xl font-rawest font-bold text-foreground mb-4">7. Betaling</h2>
            <p className="text-foreground mb-6">
            ...
            <h2 className="text-2xl font-rawest font-bold text-foreground mb-4">8. Aansprakelijkheid</h2>
            <p className="text-foreground mb-6">
            ...
            <h2 className="text-2xl font-rawest font-bold text-foreground mb-4">9. Intellectueel eigendom</h2>
            <p className="text-foreground mb-6">
            ...
            <h2 className="text-2xl font-rawest font-bold text-foreground mb-4">10. Toepasselijk recht</h2>
            <p className="text-foreground mb-6">
