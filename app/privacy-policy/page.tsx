  ...
  return (
    <div className="py-16 px-4">
      <div className="container mx-auto max-w-4xl">
        <h1 className="text-4xl font-bold text-center mb-12 text-gray-900">Privacybeleid</h1>
        ...
        <Card className="border-ffect-light/20">
          <CardContent className="p-8 prose prose-lg max-w-none">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">1. Algemene informatie</h2>
            ...
            <p className="text-gray-700 mb-4">Wij kunnen de volgende persoonsgegevens van u verzamelen:</p>
            ...
            <h2 className="text-2xl font-bold text-gray-900 mb-4">3. Waarom verzamelen wij uw gegevens?</h2>
            <p className="text-gray-700 mb-4">Wij gebruiken uw persoonsgegevens voor:</p>
            <ul className="list-disc pl-6 text-gray-700 mb-6">
