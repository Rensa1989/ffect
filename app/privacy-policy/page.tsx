  ...
  return (
    <div className="py-16 px-4">
      <div className="container mx-auto max-w-4xl">
        <h1 className="text-4xl font-bold text-center mb-12 text-foreground">Privacybeleid</h1>
        ...
        <Card className="border-ffect-light/20 bg-card text-card-foreground">
          <CardContent className="p-8 prose prose-lg max-w-none">
            <h2 className="text-2xl font-bold text-foreground mb-4">1. Algemene informatie</h2>
            ...
            <h2 className="text-2xl font-bold text-foreground mb-4">3. Waarom verzamelen wij uw gegevens?</h2>
            ...
            <h2 className="text-2xl font-bold text-foreground mb-4">4. Rechtsgrond voor verwerking</h2>
            <p className="text-foreground mb-6">
            ...
            <h2 className="text-2xl font-bold text-foreground mb-4">7. Beveiliging</h2>
            <p className="text-foreground mb-6">
